...
try
    ...
    for bkIdx = 1:nBks
        ...
        elseif isequal(trialsFx{bkIdx},@showTrials_key2) % active task
            instrucBlock_key(params,rects,display,sessMins,nBks,bkIdx);
        end
        ...
        if bkIdx<nBks
            ...
            msg = sprintf('Block %d complete.\nPlease let the experimenter know.',bkIdx);
