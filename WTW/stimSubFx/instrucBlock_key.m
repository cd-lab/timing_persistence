...
switch bkIdx
    case 1
        ...
        msg{2} = sprintf('Each token is worth %d %s%s at first. You can increase its value by repeatedly pressing the spacebar. After some time, the token will "mature" and be worth %d %ss.',...
